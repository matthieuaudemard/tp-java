...
import org.cours.java.model.objet.PotionSoin;
...
public class MainModel {
    public static void main(String[] args) {
        ...
        final PotionSoin potionSoin = new PotionSoin();
        ...
        unites.add(new UniteArmee("Troll", true, TypeUnite.HUMANOIDE, 200, armeFactory.create("massue")));
